...
<div class="container">
    <div class="card mx-auto max-width-600 mt-5">
        <div class="card-body">
            ...
            <form novalidate="novalidate" method="post" action="{{ $base_url }}/save-database-info" id="form-install"
                data-form="{{ $base_url }}/?step=2" data-btn-id="btn-install">
                ...
                <div class="mb-3">
                    <button class="btn btn-primary d-grid w-100" id="btn-install" type="submit">{{ __('Continue')
                        }}</button>
                </div>
            ...
            <form novalidate="novalidate" method="post" action="{{ $base_url }}/create-database-tables"
                ...
                <p>{{__('We have created the config file. In the next step, we will create database tables, Click
                    Continue.')}}</p>
            ...
            <form novalidate="novalidate" method="post" action="{{ $base_url }}/save-primary-data" id="form-install"
                data-form="{{ $base_url }}/?step=4" data-btn-id="btn-install">

                <h5 class="mb-2">{{ __('User') }}</h5>
                <p>{{ __('We have created database tables. Now we will create the first user and generate initial
                    data.') }}</p>
                ...
                <div class="mb-3">
                    ...
                    <small>{{ __('Remember, it is the password you will use to log in, not the database password.')
                        }}</small>
                </div>
