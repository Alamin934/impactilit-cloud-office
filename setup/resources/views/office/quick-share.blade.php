...
<div class="row">
    <div class="col-md-6">
        <div class="card">
            <div class="card-body">
                <form novalidate="novalidate" method="post" action="{{route('office.save-quick-share')}}"
                    ...
                    <div class="mb-4">
                        ...
                        <div>
                            <div class="form-check form-check-inline mb-3">
                                <input class="form-check-input share-type" type="radio" name="type" id="type_url"
                                    value="url">
                            ...
                            <div class="form-check form-check-inline mb-3">
                                <input class="form-check-input share-type" type="radio" name="type" id="type_video"
                                    value="video">
                                <label class="form-check-label" for="type_video">{{__('A video')}}</label>
                            </div>

                            <div class="form-check form-check-inline mb-3">
                                <input class="form-check-input share-type" type="radio" name="type" id="type_zip_file"
                                    value="zip_file">
                ...
                <div id="block_share_file">
                    <form action="{{route('office.create-quick-share')}}" data-then="redirect" id="app-file-upload"
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" style="">
                                <li><a class="dropdown-item"
                                        href="{{$base_url}}/office/view-share/{{$share->uuid}}">{{__('Open')}}</a></li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
                                <li><a class="dropdown-item" data-delete-item="true"
                                        href="{{$base_url}}/office/delete/quick-share/{{$share->uuid}}">{{__('Delete')}}</a>
                                </li>
                            </ul>
                        </div>
                    </td>
