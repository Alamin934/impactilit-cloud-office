        ...
        <div class="row">
            ...
            <div class="col text-end">
                <button type="button" class="btn btn-primary mb-3" data-bs-toggle="modal"
                    data-bs-target="#upload_image_modal">
                    {{__('Upload Image')}}
                </button>
            </div>
        </div>
        <table id="app-data-table" class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <div class="mb-3">
                            <img src="{{config('app.url')}}/uploads/{{$file->path}}" class="rounded max-height-75"
                                loading="lazy" alt="{{$file->title}}">
                        </div>
                        <a href="{{$base_url}}/office/image-editor/{{$file->uuid}}"
                            class="btn btn-sm btn-primary">{{__('Open with Editor')}}</a>
                    </td>
                    <td>
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" style="">
                                <li><a class="dropdown-item"
                                        href="{{$base_url}}/office/view-file/{{$file->uuid}}">{{__('Open')}}</a></li>
                                <li><a class="dropdown-item"
                                        href="{{$base_url}}/office/image-editor/{{$file->uuid}}">{{__('Open with
                                        Editor')}}</a></li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
                                <li><a class="dropdown-item" data-delete-item="true"
                                        href="{{$base_url}}/office/delete/media-file/{{$file->uuid}}">{{__('Delete')}}</a>
                                </li>
                            </ul>
                        </div>
                    </td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{route('office.save-upload')}}" id="app-file-upload"
                    data-accepted-files=".jpeg,.jpg,.png,.gif" class="dropzone text-center px-4 py-6 dz-clickable">
