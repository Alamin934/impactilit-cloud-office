...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <div class="btn-group">
        ...
        <a href="{{$base_url}}/office/download-media-file/{{$media_file->uuid}}" class="btn btn-primary"><i
                class="bi bi-download"></i> {{__('Download')}}</a>
        <button type="button" class="btn btn-primary"
            data-app-modal="/office/app-modal/share-file?uuid={{$media_file->uuid}}"
    ...
    <div class="card-body">
        ...
        <div class="text-center">
            <a class="btn btn-lg btn-primary"
                href="{{$base_url}}/office/download-media-file/{{$media_file->uuid}}">{{__('Download')}}</a>
        </div>
