...
<form novalidate="novalidate" method="post" action="{{route('office.save-document')}}" id="form-document"
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div class="mb-3 btn-group">
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item"
                            href="{{$base_url}}/office/download-document?uuid={{$document->uuid}}&access_key={{$document->access_key}}&type=pdf">{{__('PDF')}}</a>
                    </li>
                    <li><a class="dropdown-item"
                            href="{{$base_url}}/office/download-document?uuid={{$document->uuid}}&access_key={{$document->access_key}}&type=docx">{{__('Word')}}</a>
                    </li>
                </ul>
            </div>
            ...
            <button type="button" class="btn btn-primary"
                data-app-modal="/office/app-modal/share-document?uuid={{$document->uuid}}"
    ...
    <div>
        ...
        <div class="table-responsive">
            <div id="app-spreadsheet-editor"
                data-load-url="{{$base_url}}/office/load-document?uuid={{$document->uuid}}&access_key={{$document->access_key}}"
                data-save-url="{{$base_url}}/office/save-document?uuid={{$document->uuid}}"></div>
        </div>
...
@elseif($document->type == 'spreadsheet')
<script src="/setup/assets/lib/xlsx.full.min.js?v=4"></script>
@endif
