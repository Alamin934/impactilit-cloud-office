                ...
                <li class="menu-item @if(($navigation ?? null) == 'quick_share') active open @endif">
                    ...
                    <ul class="menu-sub">
                        ...
                        <li class="menu-item @if(($sub_navigation ?? null) == 'quick_share_access_logs') active @endif">
                            <a href="{{$base_url}}/office/quick-share?tab=access_logs" class="menu-link">{{__('Access
                                Logs')}}</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu-item @if(($navigation ?? null) == 'settings') active open @endif">
                    ...
                    <ul class="menu-sub">
                        <li class="menu-item @if(($sub_navigation ?? null) == 'settings_general') active @endif">
                            <a href="{{$base_url}}/office/settings?tab=general" class="menu-link">{{__('General
                                Settings')}}</a>
                        </li>
                    ...
                    <ul class="navbar-nav flex-row align-items-center ms-auto">
                        ...
                        <li class="nav-item navbar-dropdown dropdown-user dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <li>
                                    <a class="dropdown-item" href="{{$base_url}}/super-admin/dashboard">{{__('Go to
                                        Super Admin')}}</a>
                                </li>
                                <li>
                                    <div class="dropdown-divider"></div>
