                ...
                <a href="{{$base_url}}/office/dashboard" class="app-brand-link">
                    <span class="app-brand-logo">
                        ...
                        <img src="{{config('app.url')}}/uploads/{{$settings['logo']}}"
                            alt="{{$settings['workspace_name'] ?? config('app.name')}}" class="max-height-35 py-1 my-2">
                        @else
                ...
                <li class="menu-item @if(($navigation ?? null) == 'landing_page') active open @endif">
                    ...
                    <ul class="menu-sub">
                        <li class="menu-item @if(($sub_navigation ?? null) == 'manage_landing_page') active @endif">
                            <a href="{{$base_url}}/super-admin/landing-page" class="menu-link">{{__('Manage
                                Sections')}}</a>
                        </li>
                        ...
                        <li
                            class="menu-item @if(($sub_navigation ?? null) == 'landing_page_privacy_policy') active @endif">
                            <a href="{{$base_url}}/super-admin/go-to/privacy-policy-editor" class="menu-link">{{__('Edit
                                Privacy Policy')}}</a>
                        </li>
                        <li
                            class="menu-item @if(($sub_navigation ?? null) == 'landing_page_terms_of_service') active @endif">
                ...
                <li class="menu-item @if(($navigation ?? null) == 'settings') active open @endif">
                    ...
                    <ul class="menu-sub">
                        <li class="menu-item @if(($sub_navigation ?? null) == 'settings_general') active @endif">
                            <a href="{{$base_url}}/super-admin/settings?tab=general" class="menu-link">{{__('General
                                Settings')}}</a>
                        </li>
                        <li class="menu-item @if(($sub_navigation ?? null) == 'settings_users') active @endif">
                            <a href="{{$base_url}}/super-admin/settings?tab=users" class="menu-link">{{__('Super
                                Admins')}}</a>
                        </li>

                        <li
                            class="menu-item @if(($sub_navigation ?? null) == 'settings_payment_gateways') active @endif">
                    ...
                    <ul class="navbar-nav flex-row align-items-center ms-auto">
                        ...
                        <li class="nav-item navbar-dropdown dropdown-user dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <a class="dropdown-item" href="#">
                                        <div class="d-flex">
                                            <div class="flex-shrink-0 me-3">
                                                <div class="avatar avatar-online">
                                                    <span
                                                        class="app-avatar-text">{{$user->first_name[0]}}{{$user->last_name[0]}}</span>
                                                </div>
                                            </div>
                                ...
                                <li>
                                    <a class="dropdown-item"
                                        href="{{$base_url}}/office/settings?tab=general">{{__('Settings')}}</a>
                                </li>
                                <li>
                                    <div class="dropdown-divider"></div>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="{{$base_url}}/office/dashboard">{{__('Switch to
                                        Office')}}</a>
                                </li>
                                <li>
                                    <div class="dropdown-divider"></div>
                ...
                <footer class="content-footer footer bg-footer-theme">
                    <div class="container-xxl py-2">
                        <div class="text-center">
                            © {{date('Y')}} <a href="{{$base_url}}" class="footer-link">{{$settings['workspace_name'] ??
                                config('app.name')}}</a> | {{__('Version')}}: {{config('app.version')}}
                        </div>
                    </div>
                </footer>
                <!-- / Footer -->
